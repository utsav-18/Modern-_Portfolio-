...
export const skills: Skill[] = [
  ...
  { name: 'SQL',          category: 'Languages', level: 72, icon: '🗃️' },
  // Frontend
  ...
  // Cloud
  { name: 'Microsoft Azure', category: 'Cloud', level: 80, icon: '☁️' },
  { name: 'AWS',         category: 'Cloud',     level: 40, icon: '🌩️' },
  // Tools
  { name: 'Git',             category: 'Tools', level: 85, icon: '🌿' },
  { name: 'GitHub',          category: 'Tools', level: 85, icon: '🐙' },
  { name: 'Razorpay',        category: 'Tools', level: 70, icon: '💳' },
  { name: 'Google Maps API', category: 'Tools', level: 68, icon: '🗺️' },
];
...
export const timeline = [
  ...
  { year: '2025', event: 'Mastered MERN Stack · Built first full-stack applications', icon: '⚛️' },
  { year: '2025', event: 'Earned Azure & OCI Certifications · Dived into Cloud Computing', icon: '☁️' },
